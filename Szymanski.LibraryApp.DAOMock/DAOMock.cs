...
public class DAOMock: IDAO
{
    ...
    public DAOMock()
    {
        ...
        _books = new List<IBook>()
        {
            new Book()
            {
                Id = 1, Name = "Book1", Author = _authors[0], Publisher = _publishers[0], ReleaseYear = 2001, Genres =
                    new HashSet<Genre>()
                    {
                        Genre.Fantasy
                    }
            ...
            new Book()
            {
                Id = 2, Name = "Book2", Author = _authors[1], Publisher = _publishers[0], ReleaseYear = 2000, Genres =
                    new HashSet<Genre>()
                    {
                        Genre.Horror,
                        Genre.Romance
            ...
            new Book()
            {
                Id = 3, Name = "Book3", Author = _authors[2], Publisher = _publishers[1], ReleaseYear = 1990, Genres =
                    new HashSet<Genre>()
                    {
                        Genre.Romance,
                        Genre.Fantasy
